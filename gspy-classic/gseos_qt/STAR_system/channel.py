...
from STAR_system.STAR_enums import STAR_CHANNEL_DIRECTION, STAR_CHANNEL_TYPE, STAR_OPERATION_RESULT, STAR_EOP_TYPE,\
...
from STAR_system.transfer_operations import TransferOperation
