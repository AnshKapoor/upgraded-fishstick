...
from gspy_egse.gui.STAR_system.STAR_structure_classes import HardwareInfo, DeviceIdentifierInformation, NetworkDiscoveryInformation,\
                                               RoutingTableEntry, RouterGlobalState
from gspy_egse.gui.STAR_system.STAR_structures import STAR_CFG_FPGA_INFO, STAR_CFG_DEVICE_IDENTIFIER_INFO, STAR_CFG_NETWORK_DISCOVERY_INFO,\
                                        STAR_CFG_GAR_ENTRY, STAR_CFG_ROUTER_GLOBAL_STATE
from gspy_egse.gui.STAR_system.STAR_enums import STAR_CONFIG_OP_RESULT, STAR_CFG_DEVICE_TYPE, STAR_CFG_TIMEOUT_MODE, STAR_CFG_PORT_TIMEOUT,\
