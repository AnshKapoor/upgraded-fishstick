...
from gspy_egse.gui.STAR_system.error_in_data import STAR_ERROR_IN_DATA_TYPE
...
from gspy_egse.gui.STAR_system.STAR_structures import STAR_STREAM_ITEM, STAR_SPACEWIRE_ADDRESS
