...
from gspy_egse.gui.STAR_system.STAR_structure_classes import ExternalPortErrors, ExternalPortStatus
from gspy_egse.gui.STAR_system.STAR_structures import STAR_CFG_EXTERNAL_PORT_ERRORS, STAR_CFG_EXTERNAL_PORT_STATUS
