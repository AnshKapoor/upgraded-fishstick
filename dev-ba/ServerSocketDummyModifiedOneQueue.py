...
class Server:
    """
    Dummy Server used in test 2 with only one queue for each communication.
    ...
    def sortPackets(self, payloadType, payload):
        """..."""
        print(f"{payload=} in sort packets")
    ...
    def receiveMessage(self):
        ...
        while self.active:
            try:
                ...
                print(f"--databuffer first: {dataBuffer}")
